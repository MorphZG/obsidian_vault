...
>When doing a project within virtual environment you should have a file with listed [[python/requirements file|requirements]]. Tools like [[pip]] can create it but also install from it very easily.
